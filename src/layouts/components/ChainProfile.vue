  ...
  <div class="dropdown">
    <label tabindex="0" class="flex items-center">
      ...
      <div class="flex-1 w-0">
        <div
          ...
          "
          class="uppercase whitespace-nowrap text-base font-semibold text-gray-600 dark:text-gray-200 hidden md:!block"
        >
          {{
            baseStore.latest.block?.header.chain_id
          }}
        ...
        >
          {{ chainStore.connErr || 'Connected' || 'Disconnected' }}
        </div>
      </div>
    </label>
    <div
    ...
    >
      ...
      <div
        ...
        class="px-4 py-2 w-full hover:bg-gray-100 dark:hover:bg-[#046909] cursor-pointer"
        :key="index"
